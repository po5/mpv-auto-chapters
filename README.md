...
For Windows grab the [curl](https://curl.se/windows/) (extract the entire contents of the bin folder!) and [guessit-windows.exe](https://github.com/guessit-io/guessit/releases/latest) binaries. Rename the guessit file to `guessit.exe`.  
